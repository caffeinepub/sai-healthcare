  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", id: "home", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 bg-white border-b border-border shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#home", className: "flex items-center gap-2 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-bold text-xl tracking-tight", children: "Sai Healthcare" }) }),
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 max-w-7xl mx-auto px-4 py-20 md:py-28 flex flex-col md:flex-row items-center gap-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 text-white text-center md:text-left", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-3xl sm:text-4xl md:text-5xl font-normal leading-tight mb-5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-yellow-300", children: "Accurate Tests, Healthy Lives" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
