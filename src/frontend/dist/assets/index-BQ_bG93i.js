...
Message: ${inqMessage}`;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-white pb-20", id: "home", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-6 px-4", style: { backgroundColor: "#1D63FF" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center", children: [
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-3 left-1/2 -translate-x-1/2 flex gap-2 z-10", children: bannerSlides.map((slide2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              style: {
                background: i === bannerIndex ? "#1D63FF" : "rgba(255,255,255,0.7)"
              },
