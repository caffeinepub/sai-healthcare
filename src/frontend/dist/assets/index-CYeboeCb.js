    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 bg-white border-b border-gray-100 shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#home", className: "flex items-center gap-2 flex-shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 bg-primary rounded-lg flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FlaskConical, { className: "w-5 h-5 text-white" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "leading-none", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-[1.4rem] font-extrabold text-primary leading-none", children: "SAI" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-[0.6rem] font-semibold tracking-widest text-gray-700 uppercase leading-none mt-0.5", children: "HEALTHCARE" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-[0.55rem] text-gray-400 font-normal leading-none mt-0.5", children: "साई हेल्थकेअर" })
          ] })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto grid sm:grid-cols-2 lg:grid-cols-4 gap-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "leading-none", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-[1.4rem] font-extrabold text-primary leading-none", children: "SAI" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-[0.6rem] font-semibold tracking-widest text-white uppercase leading-none mt-0.5", children: "HEALTHCARE" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-[0.55rem] text-gray-400 font-normal leading-none mt-0.5", children: "साई हेल्थकेअर" })
            ] })
          ] }),
