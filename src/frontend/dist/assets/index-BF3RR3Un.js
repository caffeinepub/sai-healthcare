...
Message: ${inqMessage}`;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", id: "home", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 bg-white border-b border-border shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#home", className: "flex items-center gap-3 flex-shrink-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight border-l-4 border-primary pl-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-lg text-primary tracking-wide", children: "SAI HEALTHCARE" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-medium tracking-widest", children: "PATHOLOGY LAB | NASHIK" })
          ] })
        ] }),
      ...
      menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:hidden bg-white border-t border-border px-4 pb-4", children: [
        navLinks.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: l.href,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-7xl mx-auto px-4 py-20 md:py-28 flex flex-col md:flex-row items-center gap-12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 text-white text-center md:text-left", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block bg-white/20 text-white text-xs font-semibold px-4 py-1.5 rounded-full mb-5 tracking-widest", children: "NASHIK'S TRUSTED PATHOLOGY LAB" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-3xl sm:text-4xl md:text-5xl font-normal leading-tight mb-5", children: [
                "Trust Sai Healthcare:",
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-yellow-300", children: "Your Path to Wellness" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                "in Nashik"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/85 text-base md:text-lg mb-3 leading-relaxed", children: "All Types of Blood – Urine – Sputum Tests Available Here" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-yellow-300 font-semibold text-base mb-8", children: "✓ Free Home Collection Available" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 justify-center md:justify-start mb-8", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    href: "#packages",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-5 text-white/80 text-sm justify-center md:justify-start", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
                  {
                    href: `tel:+${PHONE}`,
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary font-bold text-sm tracking-wide", children: "SAI HEALTHCARE" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs", children: "Pathology Lab | Nashik" })
                    ] })
                  ]
                }
              )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-20 px-4 bg-blue-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl font-normal text-primary mb-3", children: "About Us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-primary mx-auto mb-5 rounded-full" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-2xl mx-auto leading-relaxed", children: "Sai Healthcare is a trusted pathology laboratory in Nashik, committed to providing accurate and affordable diagnostic services to every family in the region." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold text-foreground mb-4", children: "Why Choose Sai Healthcare?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "Located at Shop No.1, Rutik Arcade, Konark Nagar, Nashik — we serve patients with modern lab equipment, trained technicians, and prompt report delivery. Whether you need a routine blood test or a comprehensive health package, we make quality healthcare accessible and affordable." }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: whyFeatures.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center text-primary mx-auto mb-5", children: f.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-lg text-foreground mb-1", children: f.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary text-sm italic mb-3", children: f.mr }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "packages", className: "py-20 px-4 bg-orange-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl font-normal text-primary mb-3", children: "Health Packages" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-primary mx-auto mb-5 rounded-full" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Comprehensive health checkups at unbeatable prices" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-8 max-w-4xl mx-auto", children: [
          ...
          Card,
          {
            ...
            children: [
                ...
                CardHeader,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-between items-start", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-white text-xl font-bold", children: "Advance Health Checkup" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-sm italic mt-1", children: "अ‍ॅडव्हान्स हेल्थ चेकअप | संपूर्ण आरोग्य तपासणी" })
                    ] }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center gap-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/60 line-through text-sm", children: "MRP ₹5000/-" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-3xl font-bold", children: "₹1499/-" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-yellow-400 text-yellow-900 text-xs font-bold px-3 py-1 rounded-full inline-block mt-2", children: "SAVE ₹3501/-" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 mb-6", children: advanceTests.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "li",
                  {
                    className: "flex items-start gap-2 text-sm text-foreground",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "w-3.5 h-3.5 text-primary flex-shrink-0 mt-0.5" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: t.name }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground italic", children: t.desc })
                      ] })
                    ]
                  },
                  t.name
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Card,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-4 bg-muted", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-between items-start", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-primary text-xl font-bold", children: "Basic Health Checkup" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm italic mt-1", children: "बेसिक हेल्थ चेकअप | मूलभूत आरोग्य तपासणी" })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground line-through text-sm", children: "MRP ₹3000/-" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary text-3xl font-bold", children: "₹999/-" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary/10 text-primary text-xs font-bold px-3 py-1 rounded-full inline-block mt-2", children: "SAVE ₹2001/-" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-3", children: [
                  "Tests Included (",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 mb-6", children: basicTests.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "li",
                  {
                    className: "flex items-start gap-2 text-sm text-foreground",
                    children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "tests", className: "py-20 px-4 bg-sky-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl font-normal text-primary mb-3", children: "Essential Blood Tests" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-primary mx-auto mb-5 rounded-full" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Individual tests at offer prices — with Marathi names" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-5 gap-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-3", id: "test-menu", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border overflow-hidden shadow-lg", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary px-6 py-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-bold text-lg", children: "Essential Blood Test Pricing" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-sm", children: "आवश्यक रक्त तपासणी किमती" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-muted border-b border-border", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-5 py-3 text-xs font-bold text-muted-foreground uppercase tracking-wide", children: "Test Name" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center px-3 py-3 text-xs font-bold text-muted-foreground uppercase tracking-wide", children: "MRP" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center px-3 py-3 text-xs font-bold text-primary uppercase tracking-wide", children: "Offer" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-3" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: essentialTests.map((test, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "tr",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-5 py-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-sm text-foreground", children: test.en }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground italic", children: test.mr })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-3 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground line-through text-xs", children: [
                    "₹",
                    test.mrp
                  ] }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-3 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-primary font-bold text-sm", children: [
                    "₹",
                    test.offer
                  ] }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-2", id: "collection", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-2 border-primary/20 shadow-lg sticky top-24", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            CardHeader,
            {
              className: "pb-4",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-white text-xl font-bold", children: "Home Collection Booking" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-sm", children: "घरपोच संकलन बुकिंग" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleCollection, className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Label,
                {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-20 px-4 bg-blue-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl font-normal text-primary mb-3", children: "Contact Us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-primary mx-auto mb-5 rounded-full" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-6 shadow-lg", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-xl text-foreground mb-5", children: "Get In Touch" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground", children: "Phone" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "a",
                    {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Shop No.1, Rutik Arcade, Konark Nagar, Nashik" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm italic", children: "शॉप क्र.१, रुतिक आर्केड, कोनार्क नगर, नाशिक" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground", children: "Hours" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "7:00 AM – 10:00 PM, All Days (सर्व दिवस)" })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-6 shadow-lg", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-xl text-foreground mb-5", children: "Send an Inquiry" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleInquiry, className: "space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "inqName", className: "text-sm font-semibold", children: "Your Name *" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "inqName",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "inqPhone", className: "text-sm font-semibold", children: "Phone Number *" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "inqPhone",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Card,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary px-6 py-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-bold text-lg", children: "Find Us on Google Maps" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 border-t border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 mb-4", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm", children: "Shop No.1, Rutik Arcade, Konark Nagar, Nashik" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs italic", children: "शॉप क्र.१, रुतिक आर्केड, कोनार्क नगर, नाशिक" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto grid sm:grid-cols-2 lg:grid-cols-4 gap-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-xl mb-2", children: "SAI HEALTHCARE" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 text-xs tracking-widest mb-3", children: "PATHOLOGY LAB | NASHIK" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-sm leading-relaxed", children: "Your trusted pathology laboratory in Nashik — accurate results, affordable prices." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-base mb-4 text-white/90", children: "Quick Links" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-base mb-4 text-white/90", children: "Contact" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm text-white/70", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-4 h-4 text-white/50" }),
                  "9356710760"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 text-white/50 mt-0.5" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-4 h-4 text-white/50" }),
                  "7:00 AM – 10:00 PM, All Days"
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-base mb-4 text-white/90", children: "Connect" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 pt-6 border-t border-white/15 text-center text-white/45 text-xs", children: [
            "© ",
            (/* @__PURE__ */ new Date()).getFullYear(),
            " Sai Healthcare. All rights reserved. | Built with ❤️ using",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
